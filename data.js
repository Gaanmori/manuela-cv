...
export const CV_DATA = {
  ...
  contact: [
    ...
    { label: 'LinkedIn',  href: 'https://www.linkedin.com/in/manuelaecheverry-pineda-11841b288', display: 'LinkedIn',              icon: 'linkedin' },
  ],
  ...
  experience: [
    {
      ...
      company: "Restaurante Arrocería CA' RAFA — Canet d'en Berenguer",
    ...
    },
    {
      ...
      company: 'Cafetería El Encuentro — Sagunto',
    ...
    },
    {
      ...
      period:  'Abr – Jun',
      role:    'Telemarketing',
      company: 'Hy Cite — Cartagena de Indias',
    ...
    },
    {
      ...
      company: 'Movistar Colombia — Cartagena de Indias',
